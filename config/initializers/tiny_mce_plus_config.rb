...
AppConfig.default_mce_options = {
  ...
  :theme_advanced_buttons3 => "tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,iespell,media,advhr,|,print,|,ltr,rtl,|,fullscreen,|,insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak",
  :plugins => %w{media preview curblyadvimage inlinepopups safari pagebreak style layer table save advhr advlink emotions iespell inlinepopups insertdatetime searchreplace contextmenu paste directionality fullscreen visualchars xhtmlxtras template},
  :plugin_preview_pageurl => '../../../../../posts/preview',
  :plugin_preview_width => "950",
  :plugin_preview_height => "650",
  :editor_deselector => "mceNoEditor",
